...
num_frames = 31
progress_array = np.linspace(-10.0, 20.0, num_frames)
...
for frame_idx, progress in enumerate(progress_array):
    ...
    main_progress = min(progress, 10.0)
    ...
    for i in range(len(orig_vectors)):
        ...
        for j in range(3):
            ...
            p = flat_point(progress, x_local, y_local, z_local, 4.0)
...
print(f"Exported {num_frames} frames - main car portal-threads through W1->W2, ref car passes by")
